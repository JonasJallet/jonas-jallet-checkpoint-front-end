...
export type CountryQuery = { __typename?: 'Query', country: { __typename?: 'Country', code: string, emoji: string, name: string, id: number, continent?: { __typename?: 'Continent', id: number, name: string } | null } };
